...
const Header=()=>{
    return(
        ...
        <div className=" top-0 w-full h-full flex flex-col justify-center text-center text-white">
            ...
            <h3 className="text-2xl md:text-3xl pb-2"> <ReactTyped className="text-white
            " strings={['Top 1% locations Worldwide']} 
                    typeSpeed={40}
                    backSpeed={20}
                    loop/>  </h3>
            ...
            <form className="flex justify-between items-center mx-auto max-w-[600px] w-full border-2 border-white p-1 text-black rounded-2xl bg-gray-100">
                <div >
                    <input className=" sm:w-[500px] focus:outline-none font-semibold placeholder:text-cyan-600" type="text" placeholder="Search Destination" />
                </div>
                <div className="px-5 ">
